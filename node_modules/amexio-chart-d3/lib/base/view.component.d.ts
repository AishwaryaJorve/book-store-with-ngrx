...
export declare class ViewDrillableComponent implements OnInit {
    queryBarchartinput: QueryList<AmexioD3BarChartComponent>;
    barchartinput: AmexioD3BarChartComponent[];
    QueryGroupbarchartinput: QueryList<GroupbarComponent>;
    groupbarchartinput: GroupbarComponent[];
    QueryLinechartinput: QueryList<AmexioD3LineComponent>;
    linechartinput: AmexioD3LineComponent[];
    QueryPiechartinput: QueryList<AmexioD3PieChartComponent>;
    piechartinput: AmexioD3PieChartComponent[];
    QueryDonutchartinput: QueryList<AmexioD3DounutChartComponent>;
    donutchartinput: AmexioD3DounutChartComponent[];
    QueryBarStackchartinput: QueryList<BarstackComponent>;
    barstackchartinput: BarstackComponent[];
    QueryCombochartinput: QueryList<CombochartComponent>;
    combochartinput: CombochartComponent[];
    QueryHistogramchartinput: QueryList<HistogramComponent>;
    histogramchartinput: HistogramComponent[];
    QuerySatterchartinput: QueryList<ScatterchartComponent>;
    scatterchartinput: ScatterchartComponent[];
    QueryMultiareachartinput: QueryList<MultiareaComponent>;
    multiareachartinput: MultiareaComponent[];
    QueryCandlestickchartinput: QueryList<CandlestickComponent>;
    candlestickchartinput: CandlestickComponent[];
    QueryBubblechartinput: QueryList<BubbleComponent>;
    bubblechartinput: BubbleComponent[];
    QueryTimechartinput: QueryList<AmexioD3TimelineChartComponent>;
